...
declare type PromiserConfigGetMessage = (
  msg: 'config-get',
...
declare type PromiserOpenMessage = (
  msg: 'open',
  params: {
    filename: string;
    vfs?: string;
...
declare type PromiserExecMessage = (
  msg: 'exec',
...
declare type PromiserExportMessage = (
  msg: 'export',
  params: {
    dbId: string;
  },
...
declare type Promiser = PromiserConfigGetMessage &
  PromiserOpenMessage &
  PromiserExecMessage &
